    ...
    <section className="relative">
      <div className="container grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4">
        <div className="flex flex-col gap-2 justify-center pt-8 md:pt-0">
          ...
          <div className="flex items-center bg-[#f1f1f1] w-max px-8 py-4 rounded-xl gap-6 mt-8">
            <div className="flex items-center gap-2 border-r-2 border-[#ccc] pr-6">
              ...
              />
              <div>
                <h3 className="text-2xl uppercase">22 - 24</h3>
                <p className="text-base uppercase">july 2025</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              />
              <div>
                <h3 className="text-2xl uppercase">04 PM</h3>
                <p className="text-base uppercase">onwards</p>
              </div>
            </div>
          </div>
          <h3 className="text-3xl text-black mt-2">Fresno, California</h3>
        </div>
        <div>
          <Image
            src={"/hero.png"}
